...
<!-- 주문상세내역 시작 { -->
<div class="container">
  <div id="sod_fin" class="sb_container">
    <div class="wrapper">

      <div class="sb_top">
        <p class="sb-title">Order details</p>
      </div>

      <?php if ($lang == "") { //(기본)영문 ?>
        <div id="sod_fin_no">Order number : <strong><?php echo $od_id; ?></strong></div>
      <?php } else if ($lang == "ko") { //국문 ?>
      ...
      <section id="sod_fin_list">
        ...
        <table>
                ...
                <tr class="th_line">
                  <?php if ($lang == "") { //(기본)영문 ?>
                    <th scope="col" id="th_itname">Product information</th>
                    <th scope="col" id="th_itqty">Qty</th>
                    <th scope="col" id="th_itprice">selling price</th>
                    <th scope="col" id="th_itpt">Point</th>
                    <th scope="col" id="th_itsd">Shipping fee</th>
                    <th scope="col" id="th_itsum">Subtotal</th>
                    <th scope="col" id="th_itst">Status</th>
                  <?php } else if ($lang == "ko") { //국문 ?>
                ...
                for($i=0; $row=sql_fetch_array($result); $i++) {
                    $image = get_it_image($row['it_id'], 85, 50);
                    ...
                    if ($lang == "") { //(기본)영문
                      ...
                      {
                          case 1:
                              $ct_send_cost = 'pay later';
                              break;
                          case 2:
                              $ct_send_cost = 'free';
                              break;
                          default:
                              $ct_send_cost = 'upfront';
                              break;
                      }
                    } else if ($lang == "ko") { //국문
                      switch($row['ct_send_cost'])
      ...
      <div class="sod_left">
          <h2>
            <?php if ($lang == "") { //(기본)영문
                  echo "Payment/Delivery Information";
              } else if ($lang == "ko") { //국문
                  echo "결제/배송 정보";
            }?>
          </h2>
          ...
          if($od['od_receipt_price'] > 0)
            ...
            {
              if($lang == "") { //(기본)영문
                $od_receipt_price = 'The deposit has not been made yet or the deposit information has not been entered.';
              } else if ($lang == "ko") { //국문
          ...
          <section id="sod_fin_dvr">
              ...
              <div class="tbl_head01 tbl_wrap">
                  <table>
                    ...
                    <tr>
                        <?php if ($lang == "") { //(기본)영문 ?>
                          <td class="empty_table">You haven't shipped it yet or entered the shipping information.</td>
                        <?php } else if ($lang == "ko") { //국문 ?>
      ...
      <div class="sod_right">
          <ul id="sod_bsk_tot2">
              ...
              <strong><?php echo display_price($tot_price); ?></strong></li>
              <?php
              if ($misu_price > 0) {
              echo '<li class="sod_fin_tot">';
              if ($lang == "") { //(기본)영문
                echo '<span>Outstanding amount</span>'.PHP_EOL;
              } else if ($lang == "ko") { //국문
              ...
              <li id="alrdy" class="sod_fin_tot">
                ...
                <?php if ($lang == "") { //(기본)영문
                  ...
                  <div>
                      ...
                      </span><?php echo number_format($od['od_receipt_point']); ?>
                        <?php if ($lang == "") { //(기본)영문
                            echo "P";
                        } else if ($lang == "ko") { //국문
                            echo "점";
                      ...
                      </span><?php echo number_format($od['od_receipt_price']); ?>
                      <?php if ($lang == "") { //(기본)영문
                          echo "won";
                      } else if ($lang == "ko") { //국문
                          echo "원";
          ...
          <section id="sod_fin_pay">
              ...
              <ul>
                ...
                <li>
                    ...
                    <span>
                      <?php 
                      $methodResult = check_pay_name_replace($od['od_settle_case'], $od, 1);
                      if($lang == "") { //(기본)영문
                        if ($methodResult == '무통장') {
                          echo 'Bank transfer';
                        }
                ...
                <li>
                    ...
                    <span>
                        ...
                        ?>
                        <a href="javascript:;" onclick="<?php echo $hp_receipt_script; ?>">
                        <?php if ($lang == "") { //(기본)영문
                        ...
                        ?>
                        <a href="javascript:;" onclick="<?php echo $card_receipt_script; ?>">
                        <?php if ($lang == "") { //(기본)영문
                            echo "Receipt Printing";
                        } else if ($lang == "ko") { //국문
                            echo "영수증 출력";
                ...
                <li>
                    ...
                    ?>
                        <a href="javascript:;" onclick="<?php echo $cash_receipt_script; ?>" class="btn_frmline">
                        <?php if ($lang == "") { //(기본)영문
                            echo "Check cash receipt";
                        } else if ($lang == "ko") { //국문
                            echo "현금영수증 확인하기";
                        }?>
                        </a>
                    ...
                    {
                    ?>
                        <a href="javascript:;" onclick="window.open('<?php echo G5_SHOP_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');" class="btn_frmline is-long-text">
                        <?php if ($lang == "") { //(기본)영문
                            echo "Click to issue a cash receipt.";
                        } else if ($lang == "ko") { //국문
                            echo "현금영수증을 발급하시려면 클릭하십시오.";
                        }?>
                        </a>
                    <?php } ?>
                    </span>
